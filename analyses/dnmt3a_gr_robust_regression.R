...
dnmt3a_rqfit1 <- rlm(growth_rate ~ indager + indsex + cvd + lld + bb + chol + htn + antiplatelets + RAAS, data = dnmt3a_chip_repeats_cvd)
...
dnmt3a_rqfit2 <- rlm(growth_rate2_percentage ~ indager + indsex + cvd + lld + bb + chol + htn + antiplatelets + RAAS, data = dnmt3a_chip_repeats_single2)
