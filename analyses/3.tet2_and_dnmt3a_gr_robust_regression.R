...
chip_repeats_comorbs_drugs <- chip_cases_w8_9_comorbs_w6drugs %>% dplyr::filter(chip_cases_w8_9_comorbs_w6drugs$missing < 4)
...
#now replace placeholder 0.01 VAFs with lod
...
nrow(tet2_chip_repeats_single[tet2_chip_repeats_single$chol.y <0, ])
...
tet2_chip_repeats_cvd <- subset(tet2_chip_repeats_single, select = c("idauniq", "growth_rate", "indager", "indsex", "cvd", "lld", "bb.y", "chol", "htn", "antiplatelets", "RAAS", "current_smoker", "log_initial_vaf"))
...
#with bb
robust_tet2_gr1 <- rlm(growth_rate ~ indager + indsex + cvd + bb.y + lld + chol + htn + antiplatelets + log_initial_vaf, data = tet2_chip_repeats_cvd)
summary(robust_tet2_gr1)
tidy(robust_tet2_gr1, conf.int = TRUE)
rob.pvals(robust_tet2_gr1)

#with RAAS
robust_tet2_gr1_raas<- rlm(growth_rate ~ indager + indsex + cvd + RAAS + lld + chol.y + htn + antiplatelets + log_initial_vaf, data = tet2_chip_repeats_cvd)
summary(robust_tet2_gr1_raas)
tidy(robust_tet2_gr1_raas, conf.int = TRUE)
rob.pvals(robust_tet2_gr1_raas)
...
#now look for additional associations adjusted for age and initial vaf
#current smoker
robust_tet2_1_smoke <- rlm(growth_rate ~ indager + indsex + log_initial_vaf + current_smoker, data = tet2_chip_repeats_single)
summary(robust_tet2_1_smoke)
tidy(robust_tet2_1_smoke, conf.int = TRUE)
rob.pvals(robust_tet2_1_smoke)

#hscrp
robust_tet2_1_crp <- rlm(growth_rate ~ indager + indsex + log_initial_vaf + hscrp.y, data = tet2_chip_repeats_single)
summary(robust_tet2_1_crp)
tidy(robust_tet2_1_crp, conf.int = TRUE)
rob.pvals(robust_tet2_1_crp)

#diabetes
robust_tet2_1_diabetes <- rlm(growth_rate ~ indager + indsex + log_initial_vaf + diabetes, data = tet2_chip_repeats_single)
summary(robust_tet2_1_diabetes)
tidy(robust_tet2_1_diabetes, conf.int = TRUE)
rob.pvals(robust_tet2_1_diabetes)
...
robust_tet2_gr2 <- rlm(growth_rate2_percentage ~ indager + indsex + cvd + lld + bb.y + chol.y + htn + antiplatelets + log_initial_vaf, data = tet2_chip_repeats_single2 )
...
#with RAAS
robust_tet2_gr2_raas<- rlm(growth_rate2_percentage ~ indager + indsex + cvd + RAAS + lld + chol.y + htn + antiplatelets + log_initial_vaf, data = tet2_chip_repeats_single2)
summary(robust_tet2_gr2_raas)
tidy(robust_tet2_gr2_raas, conf.int = TRUE)
rob.pvals(robust_tet2_gr2_raas)
...
#now look for additional associations adjusted for age and initial vaf
#current smoker
robust_tet2_2_smoke <- rlm(growth_rate2 ~ indager + indsex + log_initial_vaf + current_smoker, data = tet2_chip_repeats_single2)
summary(robust_tet2_2_smoke)
tidy(robust_tet2_2_smoke, conf.int = TRUE)
rob.pvals(robust_tet2_2_smoke)

#hscrp
robust_tet2_2_crp <- rlm(growth_rate2 ~ indager + indsex + log_initial_vaf + hscrp.y, data = tet2_chip_repeats_single2)
summary(robust_tet2_2_crp)
tidy(robust_tet2_2_crp, conf.int = TRUE)
rob.pvals(robust_tet2_2_crp)

#diabetes
robust_tet2_2_diabetes <- rlm(growth_rate2 ~ indager + indsex + log_initial_vaf + diabetes, data = tet2_chip_repeats_single2)
summary(robust_tet2_2_diabetes)
tidy(robust_tet2_2_diabetes, conf.int = TRUE)
rob.pvals(robust_tet2_2_diabetes)
...
#count how many missing cholesterol measurement 
nrow(dnmt3a_chip_repeats_single[dnmt3a_chip_repeats_single$chol.y <0, ])
...
#simplify to just cvd relevant variables for robust regression
dnmt3a_chip_repeats_cvd <- subset(dnmt3a_chip_repeats_single, select = c("idauniq", "growth_rate", "indager", "indsex", "cvd", "lld", "bb.y", "chol.y", "htn", "antiplatelets", "RAAS", "current_smoker", "log_initial_vaf"))
...
#run robust regression for growth rate method 1
robust_dnmt3a_gr1 <- rlm(growth_rate ~ indager + indsex + cvd + bb.y + lld + chol.y + htn + antiplatelets + log_initial_vaf, data = dnmt3a_chip_repeats_cvd)
summary(robust_dnmt3a_gr1)
tidy(robust_dnmt3a_gr1, conf.int = TRUE)
rob.pvals(robust_dnmt3a_gr1)

gvif(robust_dnmt3a_gr1)
...
#with RAAS
robust_dnmt3a_gr1_raas<- rlm(growth_rate ~ indager + indsex + cvd + RAAS + lld + chol.y + htn + antiplatelets + log_initial_vaf, data = dnmt3a_chip_repeats_cvd)
summary(robust_dnmt3a_gr1_raas)
tidy(robust_dnmt3a_gr1_raas, conf.int = TRUE)
rob.pvals(robust_dnmt3a_gr1_raas)


#now look for additional associations adjusted for age and initial vaf
#current smoker
robust_dnmt3a_1_smoke <- rlm(growth_rate ~ indager + indsex + log_initial_vaf + current_smoker, data = dnmt3a_chip_repeats_single)
summary(robust_dnmt3a_1_smoke)
tidy(robust_dnmt3a_1_smoke, conf.int = TRUE)
rob.pvals(robust_dnmt3a_1_smoke)

#hscrp
robust_dnmt3a_1_crp <- rlm(growth_rate ~ indager + indsex + log_initial_vaf + hscrp.y, data = dnmt3a_chip_repeats_single)
summary(robust_dnmt3a_1_crp)
tidy(robust_dnmt3a_1_crp, conf.int = TRUE)
rob.pvals(robust_dnmt3a_1_crp)

#diabetes
robust_dnmt3a_1_diabetes <- rlm(growth_rate ~ indager + indsex + log_initial_vaf + diabetes, data = dnmt3a_chip_repeats_single)
summary(robust_dnmt3a_1_diabetes)
tidy(robust_dnmt3a_1_diabetes, conf.int = TRUE)
rob.pvals(robust_dnmt3a_1_diabetes)
...
robust_dnmt3a_gr2 <- rlm(growth_rate2_percentage ~ indager + indsex + cvd + lld + bb.y + chol.y + htn + antiplatelets + log_initial_vaf, data = dnmt3a_chip_repeats_single2 )
summary(robust_dnmt3a_gr2)
tidy(robust_dnmt3a_gr2, conf.int = TRUE)
rob.pvals(robust_dnmt3a_gr2)


#with RAAS
robust_dnmt3a_gr2_raas<- rlm(growth_rate2_percentage ~ indager + indsex + cvd + RAAS + lld + chol.y + htn + antiplatelets + log_initial_vaf, data = dnmt3a_chip_repeats_single2)
summary(robust_dnmt3a_gr2_raas)
tidy(robust_dnmt3a_gr2_raas, conf.int = TRUE)
rob.pvals(robust_dnmt3a_gr2_raas)


#now look for additional associations adjusted for age and initial vaf
#current smoker
robust_dnmt3a_2_smoke <- rlm(growth_rate2 ~ indager + indsex + log_initial_vaf + current_smoker, data = dnmt3a_chip_repeats_single2)
summary(robust_dnmt3a_2_smoke)
tidy(robust_dnmt3a_2_smoke, conf.int = TRUE)
rob.pvals(robust_dnmt3a_2_smoke)

#hscrp
robust_dnmt3a_2_crp <- rlm(growth_rate2 ~ indager + indsex + log_initial_vaf + hscrp.y, data = dnmt3a_chip_repeats_single2)
summary(robust_dnmt3a_2_crp)
tidy(robust_dnmt3a_2_crp, conf.int = TRUE)
rob.pvals(robust_dnmt3a_2_crp)

#diabetes
robust_dnmt3a_2_diabetes <- rlm(growth_rate2 ~ indager + indsex + log_initial_vaf + diabetes, data = dnmt3a_chip_repeats_single2)
summary(robust_dnmt3a_2_diabetes)
tidy(robust_dnmt3a_2_diabetes, conf.int = TRUE)
rob.pvals(robust_dnmt3a_2_diabetes)




#got to here
save.image("growth_rate_calcs_data.RData")
...
#simplify to just cvd relevant variables for robust regression
tet2_chip_repeats_cvd_0.01 <- subset(tet2_chip_repeats_single_0.01, select = c("idauniq", "growth_rate", "indager", "indsex", "cvd", "lld", "bb.y", "chol", "htn", "antiplatelets", "RAAS", "current_smoker", "log_initial_vaf"))
...
#run robust regression for growth rate method 1
robust_tet2_gr1_0.01 <- rlm(growth_rate ~ indager + indsex + cvd + bb.y + lld + chol + htn + antiplatelets + log_initial_vaf, data = tet2_chip_repeats_cvd_0.01)
summary(robust_tet2_gr1_0.01)
tidy(robust_tet2_gr1_0.01, conf.int = TRUE)
rob.pvals(robust_tet2_gr1_0.01)

gvif(robust_tet2_gr1_0.01)


#method 2 - 0.01 sensitivity analysis

tet2_chip_repeats_cvd2_0.01 <- subset(tet2_chip_repeats_single_0.01, select = c(idauniq, AF_2c, AF_4c, AF_6c, AF_8c, AF_9c, indager, indsex, cvd, bb.y, lld, chol, htn, antiplatelets, log_initial_vaf))
...
robust_tet2_gr2_0.01 <- rlm(growth_rate2_percentage ~ indager + indsex + cvd + bb.y + lld + chol + htn + antiplatelets + log_initial_vaf, data = tet2_chip_repeats_cvd2_0.01)
summary(robust_tet2_gr2_0.01)
tidy(robust_tet2_gr2_0.01, conf.int = TRUE)
rob.pvals(robust_tet2_gr2_0.01)



#dnmt3a - 0.01 sensitivity analysis
...
#simplify to just cvd relevant variables for robust regression
dnmt3a_chip_repeats_cvd_0.01 <- subset(dnmt3a_chip_repeats_single_0.01, select = c("idauniq", "growth_rate", "indager", "indsex", "cvd", "lld", "bb.y", "chol", "htn", "antiplatelets", "RAAS", "current_smoker", "log_initial_vaf"))
...
#run robust regression for growth rate method 1
robust_dnmt3a_gr1_0.01 <- rlm(growth_rate ~ indager + indsex + cvd + bb.y + lld + chol + htn + antiplatelets + log_initial_vaf, data = dnmt3a_chip_repeats_cvd_0.01)
summary(robust_dnmt3a_gr1_0.01)
tidy(robust_dnmt3a_gr1_0.01, conf.int = TRUE)
rob.pvals(robust_dnmt3a_gr1_0.01)

gvif(robust_dnmt3a_gr1_0.01)

#method 2 - 0.01 sensitivity analysis

dnmt3a_chip_repeats_cvd2_0.01 <- subset(dnmt3a_chip_repeats_single_0.01, select = c(idauniq, AF_2c, AF_4c, AF_6c, AF_8c, AF_9c, indager, indsex, cvd, bb.y, lld, chol, htn, antiplatelets, log_initial_vaf))
...
#run robust regression for growth rate method 2
robust_dnmt3a_gr2_0.01 <- rlm(growth_rate2_percentage ~ indager + indsex + cvd + bb.y + lld + chol + htn + antiplatelets + log_initial_vaf, data = dnmt3a_chip_repeats_cvd2_0.01)
summary(robust_dnmt3a_gr2_0.01)
tidy(robust_dnmt3a_gr2_0.01, conf.int = TRUE)
rob.pvals(robust_dnmt3a_gr2_0.01)
